                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li class="scroll-to-section">
                                    <a href="/jelajahi" class="{{ request()->is('jelajahi') ? 'active' : '' }}">Jelajahi</a>
                                </li>
                                <li class="submenu">
                                    <a href="#">Pages</a>
                                    <ul>
                                        <li><a href="/tentangkami" class="{{ request()->is('tentangkami') ? 'active' : '' }}">About Us</a></li>
                                        <li><a href="/single" class="{{ request()->is('single') ? 'active' : '' }}">Single Product</a></li>
                                        <li><a href="/kontak" class="{{ request()->is('kontak') ? 'active' : '' }}">Contact Us</a></li>
                                    </ul>
                                </li>
                                ...
                                @if (Auth::check())
                                    ...
                                    <li class="submenu scroll-to-section">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="/daftarkursus">Kursus Saya</a></li>
